...
| 8 | Release engineering: v0.1.0 — Authenticode signing, notarized DMG, winget/scoop PRs, Docker (ghcr.io), screenshots → demo GIF | FM-1, FM-2, FM-14, FM-20 full pass | **pipeline complete and proven** (2026-09-21) — macOS job, ghcr image, winget templates, runbook (RELEASE.md), real screenshots. **CEO ruling 2026-09-21: ships UNSIGNED — no certificate purchases.** SmartScreen ("More info → Run anyway") and Gatekeeper friction documented; macOS best-effort, Windows-first. Public v0.1.0 is one tag away whenever the CEO says go |
